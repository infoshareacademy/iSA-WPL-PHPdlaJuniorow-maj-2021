...
use App\Domain\AppThreePing\AppTwoPingException;
use App\Infrastructure\ApiClients\AbstractClient;
use GuzzleHttp\Exception\GuzzleException;
use Psr\Http\Message\ResponseInterface;

class AppTwoClient extends AbstractClient
{
    public function __construct(AppTwoConfig $config)
    {
